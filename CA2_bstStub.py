...
class BSTNode:
    ...
    def search_node(self, searchitem):
        ...
        if self._element is None:
            return None
        elif searchitem._element < self._element:
            if self._leftchild is None:
                return None
            else:
                return self._leftchild.search_node(searchitem)
        elif self._element < searchitem._element:
    ...
    def remove(self, searchitem):
        ...
        """
        node = self.remove_node(BSTNode(searchitem))
        if node:
            return node._element
        return None
    ...
    def remove_node(self):
        ...
        """
        if self.full():
            maxnode = self._leftchild.findmaxnode

            self._element = maxnode
    ...
    def _testadd():
        node = BSTNode(TestClass("Melvin and Howard", "19/09/1980"))
        node._print_structure()
        print('> adding Melvin and Howard')
        node.add(TestClass("Memento", "11/10/2000"))
        node._print_structure()
        ...
        node._print_structure()
        print('> adding Z')
        node.add(TestClass("Z", "21/09/2016"))
        node._print_structure()
        print('> adding Melody')
        node.add(TestClass("Melody", "21/03/2007"))
        node._print_structure()
        print("Finding: ")
        print(node.search(TestClass("Penis gang", "21/09/2016")))
        print("Maxnode: ")
